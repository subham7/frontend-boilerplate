...
loadSalesWithinDates = function loadSalesWithinDates() {
  _this2.props.topCategories('6e4a829b-b32d-487c-800f-d80a6d185a92', '2018-07-04', '2021-07-06').then(function (data) {
    _this2.setState({
      topCategoryData: data.splice(0, 3)
    });
  }).catch(function (err) {
...
//# sourceMappingURL=dashboard.js.6e26d0f0eec248dec257.hot-update.js.map