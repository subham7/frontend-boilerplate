...
// CONCATENATED MODULE: ./src/components/organisms/forms/signUp.js
...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(F, [{
    ...
    value: function render() {
      ...
      }, "I agree with terms and conditions")), external_react_default.a.createElement("div", {
        style: {
          marginLeft: "18%"
        }
      ...
      }, "Log-in"), external_react_default.a.createElement("h4", {
        style: {
          marginLeft: 75,
          marginTop: 25
        }
      }, "Already have an account? ", external_react_default.a.createElement(link_default.a, {
        as: "/",
        href: "/"
...
// CONCATENATED MODULE: ./src/components/templates/signup/index.js
...
var signup_Login = function Login(props) {
  ...
  }, external_react_default.a.createElement(signUp, {
...
/* harmony default export */ var signup = (signup_Login);
...
function (_React$Component) {
  ...
  Object(createClass["a" /* default */])(App, [{
    ...
    value: function handleFormData(data) {
      ...
      delete data.values.c_password; // Add necesarry data
      ...
      this.props.signupDispatch(dispatchData).then(function (res) {
        // confirm if user was created 
        console.log(res);
        alert("Account created!! Please Login to continue");
        router_default.a.push("/");
      }).catch(function (err) {
        message_default.a.error(err.response.data.error);
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(signup, {
...
var signup_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    signupDispatch: function signupDispatch(signupData) {
      return dispatch(reduxHelper["signup"].action(signupData));
    }
  };
};

/* harmony default export */ var pages_signup = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, signup_mapDispatchToProps)(signup_App));
