...
function (_Component) {
  ...
  function App(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_16__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_14__["default"])(_this), "loadLocationSales", function () {
      _this.props.topCategories('bdf26304-0a68-48d9-a20f-8fb60ca6e4c0').then(function (data) {
        _this.setState({
          topCategoryData: data.splice(0, 3)
        });
      }).catch(function (err) {
    ...
    value: function render() {
      ...
      var configTopSalePerson = {
        ...
        series: [{
          type: 'column',
          colorByPoint: true,
          data: this.state.topSalesmanData.salesunits,
          showInLegend: false
        }]
      };
...
//# sourceMappingURL=dashboard.js.85f75a0a10ff6c08e4fa.hot-update.js.map