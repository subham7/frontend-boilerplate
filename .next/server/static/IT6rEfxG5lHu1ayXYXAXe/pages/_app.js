...
keys_default()(reduxHelper).map(function (functionName) {
  reducers[functionName] = reduxHelper[functionName].reducer;
});

/* harmony default export */ var src_reducers = (Object(external_redux_["combineReducers"])(reducers));
...
function initializeStore() {
  ...
  return Object(external_redux_["createStore"])(src_reducers, initialState, Object(external_redux_devtools_extension_["composeWithDevTools"])(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a)));
}
