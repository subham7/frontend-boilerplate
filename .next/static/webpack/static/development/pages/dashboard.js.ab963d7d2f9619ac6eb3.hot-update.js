...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__["default"])(App, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.getSwagger1().then(function (res) {
        console.log(res, "swageeeer");
      }).catch(function (err) {
        console.log(err, "swaggger errrorr");
      });
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    getSwagger: function getSwagger() {
      return dispatch(_src_reduxHelper__WEBPACK_IMPORTED_MODULE_19__["swagger"].action());
    }
  };
};
...
//# sourceMappingURL=dashboard.js.ab963d7d2f9619ac6eb3.hot-update.js.map