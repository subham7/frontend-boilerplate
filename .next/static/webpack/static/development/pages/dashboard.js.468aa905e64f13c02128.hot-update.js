...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__["default"])(App, [{
    ...
    value: function componentDidMount() {
      console.log(this.props.business.response.data, "busuuu");
      this.loadTopItems();
...
loadSalesWithinDates = function loadSalesWithinDates() {
  _this2.props.getSalesDate().then(function (data) {
    _this2.setState({
      topCategoryData: data.splice(0, 3)
    });
  }).catch(function (err) {
...
//# sourceMappingURL=dashboard.js.468aa905e64f13c02128.hot-update.js.map