...
loadSalesWithinDates = function loadSalesWithinDates() {
  _this2.props.getSalesDate(_this2.props.business.response.data[0].businessID).then(function (data) {
    console.log(data, "hehehhehhehh"); // this.setState({ topCategoryData: data.splice(0, 3) })
  }).catch(function (err) {
    console.log(err);
  });
...
//# sourceMappingURL=dashboard.js.fc07718ab45e3a9425d8.hot-update.js.map