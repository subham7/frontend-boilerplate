      ...
      if (_babel_runtime_corejs2_core_js_array_is_array__WEBPACK_IMPORTED_MODULE_0___default()(data)) {
        data.map(function (item) {
          ...
          object.handleFeatures = {
            ...
            handleAssgin: function handleAssgin(data, id, cb) {
              console.log(data, id, cb, "received data");
            },
            taxesData: _this5.createSelectTaxData(_this5.props.response)
          };
          temp.push(object);
        });
      }
...
//# sourceMappingURL=dashboard.js.67284aed535ac65214fa.hot-update.js.map