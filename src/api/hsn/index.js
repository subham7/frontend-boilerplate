...
export const addhsncodetaxcategories= (object) => axios.post(`${ROOTURL}/hsncodetaxcategories`, object)

export const taxCategoryHsn = hsnID => {
    axios.get(`${ROOTURL}/hsncodetaxcategories?_where=(hsncode,eq,${hsnID})`)
}